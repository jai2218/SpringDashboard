...
<head>
 ...
 <link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/img/favicon.png">
  ...
  <title>Jai Shanker : Admin Dashboard</title>
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/resources/img/avatar-mini.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/resources/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/resources/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/resources/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">Jai Shanker</span>
                            <b class="caret"></b>
                        </a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="./fatchUserDetails">User Details</a></li>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <table class="table bootstrap-datatable countries">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="${pageContext.request.contextPath}/resources/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Germany</td>
                      <td>2563</td>
                      <td>1025</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="${pageContext.request.contextPath}/resources/img/India.png" style="height:18px; margin-top:-2px;"></td>
                      <td>India</td>
                      <td>3652</td>
                      <td>2563</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="${pageContext.request.contextPath}/resources/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Spain</td>
                      <td>562</td>
                      <td>452</td>
                      <td>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-me">
                      ...
                      <div class="avatar pull-left">
                        <img src="${pageContext.request.contextPath}/resources/img/user.jpg" alt="" />
                      </div>
                    ...
                    <li class="by-other">
                      ...
                      <div class="avatar pull-right">
                        <img src="${pageContext.request.contextPath}/resources/img/user22.png" alt="" />
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="${pageContext.request.contextPath}/resources/img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>
                  </div>
                </div>
