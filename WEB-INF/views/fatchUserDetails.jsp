  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Fetch User Details</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="./index">Home</a></li>
              <li><i class="icon_document_alt"></i>Reports</li>
              <li><i class="fa fa-file-text-o"></i>Fetch User Details</li>
            </ol>
          </div>
        </div>
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Fetch User Details </header>
							<div class="panel-body">
								<form role="form">
									<div align="center">
										<h1 style="text-decoration: underline;">User Details</h1>

										<a href="addUser">Add User</a> || <a href="viewUser"> View
											User</a> <br>
										<br>
										<P>${serverTime}</P>
