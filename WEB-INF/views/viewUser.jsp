...
<head>
  ...
  <link href="${pageContext.request.contextPath}/resources/css/bootstrap-colorpicker.css" rel="stylesheet" />
  <!-- date picker -->
...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>View User</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="./index">Home</a></li>
              <li><i class="icon_document_alt"></i>Reports</li>
              <li><i class="fa fa-file-text-o"></i>View User</li>
            </ol>
          </div>
        </div>
				...
				<div class="col-sm-12">
					<section class="panel">
						<header class="panel-heading"> View User </header>
						<div class="panel-body">
							<div align="center">
								<h1 style="text-decoration: underline;">View User</h1>

								<table style="border: 2px; width: 70%; padding: 2px;" class="">
  ...
  <script src="${pageContext.request.contextPath}/resources/js/bootstrap-wysiwyg-custom.js"></script>
